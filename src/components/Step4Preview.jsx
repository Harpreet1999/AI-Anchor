  ...
  return (
    <section className="sheet">
      ...
      <StepNav
        ...
        // Not shown at all — not a no-op, not disabled — until chunking
        // has actually finished and the dataset's chunks/embeddings are
        // really loaded. There's nothing to click ahead to yet.
